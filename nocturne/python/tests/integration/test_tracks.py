...
""")
        ...
        self.assertTrue(
            self.engine.wait_for_notification("Track(name=sp, instrument=sampler, "
...
""")
        ...
        self.assertTrue(
            self.engine.wait_for_notification("Track(name=sp1, instrument=sampler, "
                                              "muted=False, volume=1.0, pan=0.0, fxs=[])"))

        self.assertTrue(self.engine.wait_for_notification("sp2"))
        self.assertTrue(
            self.engine.wait_for_notification("Track(name=sp2, instrument=sampler, "
                                              "muted=False, volume=1.0, pan=0.0, fxs=[])"))

        self.assertTrue(self.engine.wait_for_notification("sp3"))
        self.assertTrue(
            self.engine.wait_for_notification("Track(name=sp3, instrument=sampler, "
                                              "muted=False, volume=1.0, pan=0.0, fxs=[])"))
...
""")
        ...
        self.assertTrue(self.engine.wait_for_notification("sp"))
        self.assertTrue(
            self.engine.wait_for_notification("Track(name=sp, instrument=sampler, muted=False, "
