...
LowPassFilter::LowPassFilter() { InitFromParameters(); }
...
void LowPassFilter::Reset() { filter_.Reset(); }

float LowPassFilter::Process(float input) { return filter_.Process(input); }
